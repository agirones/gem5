#!/bin/bash
# Run gem5 simpoint jobs for the baseline configuration:
...
OUTPUT_DIR="${GEM5_ROOT}/runs/output/micro26/baseline/12B_-1P"
SLURM_SCRIPT="${GEM5_ROOT}/slurm/single_simpoint_job.slurm"

mkdir -p "${OUTPUT_DIR}/slurm_logs"

echo "=== Submitting baseline jobs (broadcastMax=${BROADCAST_MAX}, dependentsThreshold=${DEPENDENTS_THRESHOLD}) ==="
