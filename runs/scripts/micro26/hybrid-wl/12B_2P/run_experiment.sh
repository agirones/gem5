#!/bin/bash
# Run gem5 simpoint jobs for the Hybrid-WL configuration:
...
OUTPUT_DIR="${GEM5_ROOT}/runs/output/micro26/hybrid-wl/12B_2P"
SLURM_SCRIPT="${GEM5_ROOT}/slurm/single_simpoint_job.slurm"

mkdir -p "${OUTPUT_DIR}/slurm_logs"

echo "=== Submitting Hybrid-WL jobs (broadcastMax=${BROADCAST_MAX}, dependentsThreshold=${DEPENDENTS_THRESHOLD}) ==="
