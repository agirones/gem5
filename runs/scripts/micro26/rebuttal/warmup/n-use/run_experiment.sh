#!/bin/bash
# Warmup 50M experiment for N-Use (n-use/InO branch).
#
...
#
# Output tree:
#   runs/output/micro26/rebuttal/warmup/n-use/50M/
...
OUTPUT_DIR="${GEM5_ROOT}/runs/output/micro26/rebuttal/warmup/n-use/50M"
SLURM_SCRIPT="${GEM5_ROOT}/runs/scripts/micro26/rebuttal/ipc_relative/n-use/single_simpoint_job.slurm"

mkdir -p "${OUTPUT_DIR}/slurm_logs"

echo "=== Warmup N-Use (L1 latency ${L1_LATENCY}, warmup 50M) ==="
