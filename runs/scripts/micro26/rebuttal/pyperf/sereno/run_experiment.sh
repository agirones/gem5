#!/bin/bash
# Run pyperformance ffrun jobs for Sereno (broadcastMax=1, dependentsThreshold=2).
#
...
#
# Output tree:
#   runs/output/micro26/rebuttal/pyperf/sereno/
...
OUTPUT_DIR="${GEM5_ROOT}/runs/output/micro26/rebuttal/pyperf/sereno"
...
echo "=== Submitting Sereno pyperformance ffrun jobs ==="
