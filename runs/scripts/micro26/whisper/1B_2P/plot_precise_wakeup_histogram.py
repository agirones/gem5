...
Output:
  runs/output/micro26/whisper/1B_2P/graphs/precise_wakeup_histogram.tex
"""
...
OUTPUT_TEX = ROOT / "runs/output/micro26/whisper/1B_2P/graphs/precise_wakeup_histogram.tex"
