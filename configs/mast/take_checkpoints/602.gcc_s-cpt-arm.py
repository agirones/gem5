...
binary_path = "/home/andreug/research/microbenchmarks/spec2017/cpu2017/benchspec/CPU/602.gcc_s/run/run_base_refspeed_arm-build-64.0000/sgcc_base.arm-build-64"
benchmark_binary = BinaryResource(local_path=binary_path)

benchmark_arguments = [
    '/home/andreug/research/microbenchmarks/spec2017/cpu2017/benchspec/CPU/602.gcc_s/run/run_base_refspeed_arm-build-64.0000/gcc-pp.c',
    '-O5',
    '-fipa-pta',
    '-o',
    '/home/andreug/research/microbenchmarks/spec2017/cpu2017/benchspec/CPU/602.gcc_s/run/run_base_refspeed_arm-build-64.0000/gcc-pp.opts-O5_-fipa-pta.s',
]
